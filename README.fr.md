...
**Langage de programmation et compilateur de configuration axé sur la confidentialité.**

**Kyto** est le langage. **kura** est son compilateur CLI. Écrit en **NASM x86-64 Assembly** (Windows PE + Linux ELF).
...
[**Démarrer**](#démarrage-rapide) · [**Releases**](https://github.com/voidmute/kyto/releases/latest) · [**Documentation**](docs/configuration.md)
...
Releases **Kyto** (compilateur **kura**) : **[GitHub Releases](https://github.com/voidmute/kyto/releases/latest)** · Paquet Docker : [ghcr.io/voidmute/kyto](https://github.com/voidmute/kyto/pkgs/container/kyto).

## `.kyto.config`

Fichier lisible avec `DOMAIN`, `USERS`, commentaires `+`, et paires `CLÉ valeur`.
